...
/// <summary>
/// Provides hardcoded mappings between fault types and required skills/parts for tire manufacturing equipment.
/// In a production system, this would be fetched from a configuration service or database.
/// </summary>
public sealed class FaultMappingService : IFaultMappingService
{
    /// <summary>
    /// Mapping from fault type to required skills (case-insensitive).
    /// </summary>
    ...
    /// <summary>
    /// Mapping from fault type to required parts (case-insensitive).
    /// </summary>
    ...
    /// <summary>
    /// Default skills returned for unknown fault types.
    /// </summary>
